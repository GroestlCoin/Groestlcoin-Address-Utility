namespace BtcAddress.Forms {
    partial class EscrowTools {
        ...
        private void InitializeComponent() {
			...
			this.label5.Size = new System.Drawing.Size(709, 169);
			...
			this.label4.Size = new System.Drawing.Size(640, 13);
			this.label4.TabIndex = 7;
			this.label4.Text = "Here is the Groestlcoin address that belongs to the transaction.  Give both the Groestlcoin address and the payment invitation to the payee.";
			// 
			// button4
			// 
    ...
    "r save it or print it.";
			...
			this.label8.Size = new System.Drawing.Size(724, 169);
    ...
    "t print a paper backup.";
			...
			this.label15.Text = "The code (private key) needed to collect the funds into your Groestlcoin wallet i" +
    "s:";
			// 
			// txtRedeemAddress
			// 
