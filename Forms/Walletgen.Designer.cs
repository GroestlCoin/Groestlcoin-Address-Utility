namespace BtcAddress {
    partial class Walletgen {
        ...
        private void InitializeComponent() {
			...
			this.label1.Text = "Paper Wallet Generator generates a deterministic Groestlcoin wallet from a passph" +
    "rase.  Entering the same passphrase generates the same wallet.";
			// 
			// label2
			// 
